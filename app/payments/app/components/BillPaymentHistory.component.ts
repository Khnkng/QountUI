...
export class BillPaymentHistory {
  report:any={};
  ...
  constructor(private _router: Router,private reportService: ReportService,private excelService:ExcelService,private _toastService: ToastService,private emailService:EmailService, private switchBoard: SwitchBoard,private emailBuilder: FormBuilder) {
