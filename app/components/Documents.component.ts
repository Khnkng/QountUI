...
export class DocumentsComponent {
    ...
    fetchReceipts(){
        this.documentsService.getDocumentsByType(this.companyId, "receipt").subscribe(docs => {
    ...
    fetchBills(){
        this.documentsService.getDocumentsByType(this.companyId, "bill").subscribe(docs => {
            this.loadingService.triggerLoadingEvent(false);
    ...
    fetchRefunds(){
        this.documentsService.getDocumentsByType(this.companyId, "refund").subscribe(docs => {
            this.loadingService.triggerLoadingEvent(false);
