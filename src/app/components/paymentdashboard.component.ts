...
@Component({
    ...
    templateUrl: '../views/paymentdashboard.html'
})
export class paymentdashboardComponent {
    ...
    detailedChartIcons:string='apply';
    ...
    constructor(private _router: Router,private companyService: CompaniesService, private loadingService:LoadingService,
            private reportService: ReportService,private dateFormater:DateFormater, private numeralService:NumeralService) {
