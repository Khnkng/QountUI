...
export class AppComponent  implements OnInit, AfterViewInit {
    ...
    constructor(_switchBoard:SwitchBoard, private _router:Router, private route: ActivatedRoute,
                private toastService: ToastService, private socketService: SocketService,
                private titleService:pageTitleService, private zone: NgZone) {
        let self = this;
        this.titleService.setPageTitle("Books");
