...
$.widget( "custom.combobox", {
        ...
        this.input = $( "<input>" )
            ...
            .autocomplete({
                ...
                focus: function(event, ui) {
                    var startpos = $(this).val().length;
                    var endpos = ui.item.value.length;
                    if(startpos > 0 && endpos > 0 && ui.item.value.toLowerCase().startsWith($(this).val().toLowerCase())) {
                        $(this).val(ui.item.value);
                        base.setInputSelection(startpos, endpos);
                    }
                }
            })
    ...
    setInputSelection: function(startPos, endPos) {
