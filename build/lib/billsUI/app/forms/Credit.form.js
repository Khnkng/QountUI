/**
 * Created by seshagirivellanki on 18/01/17.
 */
"use strict";
...
var CreditForm = (function (_super) {
    __extends(CreditForm, _super);
    function CreditForm() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CreditForm.prototype.getForm = function () {
        var numberValidator = [];
        ...
        return {
            ...
            "vendorID": [''],
            "totalAmount": [0, forms_1.Validators.required],
            "companyID": [''],
            "customID": [''],
            "id": [''],
            "poNumber": [''],
            "creditDate": ['', forms_1.Validators.required],
            "endDate": [''],
            "accountNumber": [''],
            "currency": [''],
