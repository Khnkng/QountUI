...
var UsersService = (function (_super) {
    ...
    UsersService.prototype.getUsersByPrefix = function (prefix) {
        var url = this.interpolateUrl(Qount_constants_1.PATH.USERS_SERVICE, { prefix: prefix }, null);
        return this.query(url, Qount_constants_2.SOURCE_TYPE.NODE)
            .map(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    UsersService.prototype.getUsersById = function (id) {
        return this.query(Qount_constants_1.PATH.USERS + id, Qount_constants_2.SOURCE_TYPE.NODE)
            .map(function (res) { return res.json(); })
            .catch(this.handleError);
    };
