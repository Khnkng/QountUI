...
var CustomDatepicker = (function () {
    ...
    Object.defineProperty(CustomDatepicker.prototype, "maxdate", {
        set: function (_maxDate) {
            this.maxDate = new Date(_maxDate);
        },
        enumerable: true,
        configurable: true
    });
    CustomDatepicker.prototype.ngAfterViewInit = function () {
        ...
        var picker = new Pikaday({ field: elem, format: this.fmt ? this.fmt : 'MM/DD/YYYY', minDate: this.minDate, maxDate: this.maxDate ? this.maxDate : 'past',
...
__decorate([
    ...
    __metadata("design:type", String),
    __metadata("design:paramtypes", [String])
], CustomDatepicker.prototype, "maxdate", null);
